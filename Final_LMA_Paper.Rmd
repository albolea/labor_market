...
&nbsp;
\[
\log(earnings) = \beta_0 + \beta_1FreeAccess + \beta_2Hispanic + \beta_3Black + \beta_4Female + \beta_5Age(Years) + \beta_6Age^{2} + \beta_7High School Diploma or GED + \beta_8Some College + \beta_9Undergraduate Degree or Higher + \mu
\]
&nbsp;
...
&nbsp;
\[
\log(earnings)(race) = \beta_0 + \beta_1FreeAccess + \beta_4Female + \beta_5Age(Years) + \beta_6Age^{2} + \beta_7High School Diploma or GED + \beta_8Some College + \beta_9Undergraduate Degree or Higher + \mu
\]
&nbsp;
