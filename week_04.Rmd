...
# 7. Updates for the week4 

__The updates in the week4's report are: __
  
  1. Following the professor's comments from week3 and group's new thoughts to revise the criteria of __earnings__ - now it is bigger then $0.00
  
  2. Build the models as in the section 6 above. 
